...
const compagnie = {
	id: 1,
	about: `L'Enclos parle de cet _**Espace**_ Clos qui entoure chaque être humain, **l'intimité de l'être** dans toute sa complexité, l'endroit de notre **vulnérabilité.** Notre carapace. Par ses créations toujours axées sur des **écritures contemporaines**, L'Enclos souhaite ainsi ouvrir la porte de cet espace clos difficilement accessible dans la « vraie vie » et ainsi **aller à la rencontre de ses personnages dans leur profondeur**, dans les méandres de leurs pensées, dans leur sensibilité, dans leurs limites….

L'Enclos raconte également toutes ses barrières que nous avons tendance à construire autour de nous, tout **ce qui nous empêche d'avancer comme un être libre**, pensant par soi même, avec un esprit critique sur le monde dans lequel nous vivons. Nous souhaitons par le biais de nos créations, remettre en question cet enclos imaginaire en **poussant les spectateurs à la réflexion autour de problématiques propres à nos sociétés modernes**. C'est ainsi que les figures qui peuplent les créations de la Compagnie L'Enclos doivent toujours faire face à des questionnements qui résonnent comme des miroirs sur les fragilités de l'humain d'aujourd'hui.

L'Enclos accompagne souvent ses créations **d'actions de médiation** pour enrichir ses propos auprès de différents publics et faire de ses créations, un **acte citoyen.**

A savoir que la compagnie est née à la suite d'une **rencontre entre Mariana Georgieva et Sandra Wichurski**, qui par leurs visions artistiques personnelles ont créé deux spectacles ensemble : **“Te souviens tu du jour où j'ai coupé mes cheveux ?” et “J'ai 17 ans pour toujours”.** Après 5 années de collaboration, en juin 2024, leurs chemins se séparent et Sandra Wichurski prend seule la direction de la Compagnie L'Enclos.`,
};
